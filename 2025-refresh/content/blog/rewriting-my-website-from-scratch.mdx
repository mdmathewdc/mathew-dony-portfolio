...
The previous version of my portfolio website was built in 2022, so it was long overdue for a refresh. I also wanted a proper blog space to share my thoughts and experiences from my engineering career. I recently got a Cursor license, so this felt like a great project to try it out on.
