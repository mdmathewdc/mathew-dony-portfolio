...
---
The last version of my portfolio website was built in 2022. Plus, I felt compelled to add a blog to share my thoughts and experiences about the software engineering world.
Also, it was the perfect opportunity to utilize my new Cursor license.

## The Stack
1. **Next.js**: I migrated from the Next.js 12 `pages` router to Next.js 16 which has the new and shiny `app` router.
2. **Styling**: Use `useMemo` and `useCallback` judiciously
...
*P.S: There are some Easter eggs that I've hidden throughout the website*
